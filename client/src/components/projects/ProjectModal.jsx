    ...
    <Modal isOpen={!!project} onOpenChange={onClose}>
      <ModalContent>
        ...
        <ModalBody className="space-y-4">
          <Input label="Project Name" value={form.name} onValueChange={v => handleChange('name', v)} />
          <Textarea label="Description" value={form.description} onValueChange={v => handleChange('description', v)} />
        </ModalBody>
        <ModalFooter>
