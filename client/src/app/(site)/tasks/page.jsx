...
export default function TasksPage() {
  ...
  return (
    <Suspense fallback={<div>Loading...</div>} className='dark:bg-black light:bg-white'>
      <div className="">
      ...
      <TaskModal isOpen={isModalOpen} onClose={() =>setIsModalOpen(false)} initialData={selectedTask} onSaved={handleTasksSaved}/>
    </Suspense>
  )
};
